...
export class Pulsar {
    ...
    setup(): void {
        ...
        this.nodes.push(new VerletNode(this.p, (new p5.Vector(-this.p.sqrt(2 / 9) * this.dim.x, -this.p.sqrt(2 / 3) * this.dim.y, -1 / 3 * this.dim.z)).add(this.pos), 2, this.p.color(127, 90, 0)));
        this.nodes.push(new VerletNode(this.p, (new p5.Vector(0, 0, 1 * this.dim.x)).add(this.pos), 2, this.p.color(127, 90, 0)));
        ...
        this.sticks.push(new VerletStick(this.p, this.nodes[1], this.nodes[2], this.elasticity, 0, this.p.color(150, 150, 255, 125)));
        this.sticks.push(new VerletStick(this.p, this.nodes[2], this.nodes[3], this.elasticity, 0, this.p.color(150, 150, 255, 125)));
        this.sticks.push(new VerletStick(this.p, this.nodes[3], this.nodes[1], this.elasticity, 0, this.p.color(150, 150, 255, 125)));

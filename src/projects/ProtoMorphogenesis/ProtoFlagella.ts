...
export class ProtoFlagella extends ProtoMorphoBase {


    /*
    Notes:
     1. I need centroid of object, so I can find vector to node
     2. generate VerletStrand along vector based on len
     3. Attach flagella to respective node
    ...
    /*
       //this.p, this.nodes[i].pos, tail, 20, new p5.Vector(1, 1), new ProtoStyle(this.p, this.p.color(100, 100, 135), this.tailCol, .3, .5)));
       
       flagellaDetail
        flagellaDetail: number;
        flagellaLen: number;
        flagellaVertices: VerletNode[][] = [];
